 ...
 * ?                                                     BASED ON
 * @author         :  @ignlg
 * @repo           :  https://github.com/ignlg/PasswordCard
 * @description    :  PasswordCard - Flexible Password Card Generator.
 * @version        :  0.6
 *
 *
 * ?                                                     EDITED BY
 * @author         :  @psycho0verload
 * @repo           :  https://psycho0verload.github.io/PasswordCard/
 * @description    :  PasswordCard - Flexibler Passwortkarten-Generator.
 *-----------------------------------------------------------------------------------------------------------------------**/
